      ...
      <div className="col-md-12">
        <div className="banner-blocks">
                ...
                <div className="swiper-slide">
                  <div className="row banner-content p-5">
                    ...
                    <div className="img-wrapper col-md-5">
                      <img
                        src="../src/assets/images/product-thumb-1.png"
                        className="img-fluid"
                      />
                    </div>
                  </div>
          ...
          <div
            ...
            style={{
              background: 'url("../src/assets/images/ad-image-1.png") no-repeat',
          ...
          <div
            ...
            style={{
              background: 'url("../src/assets/images/ad-image-2.png") no-repeat',
              backgroundPosition: "right bottom"
            }}
          >
            <div className="row banner-content p-5">
