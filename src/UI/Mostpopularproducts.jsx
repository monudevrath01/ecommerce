...
const Mostpopularproducts = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log("Most popular products:", data);
        setProducts(data);
  ...
  // Filter most popular products (you can adjust this logic based on your data)
  const popularProducts = products.filter(product => product.popular === true);
  const displayProducts = popularProducts.length > 0 ? popularProducts : products.slice(0, 8);
